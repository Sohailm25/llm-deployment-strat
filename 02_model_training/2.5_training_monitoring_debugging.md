...
> **Navigation** | [← 2.4 Pretraining Data Mix](2.4_pretraining_data_mix_curriculum.md) | [2.6 Ray Train →](2.6_ray_train_guide.md)
>
> | | |
> |---|---|
> | **Prerequisites** | [2.3 Distributed Training](2.3_distributed_training_infrastructure.md) |
> | **Related** | [8.2 Experiment Tracking](../08_mlops_lifecycle/8.2_experiment_tracking_guide.md) &#124; [10.1 Monitoring Strategy](../10_monitoring_observability/10.1_llm_monitoring_strategy_guide.md) |
> | **Next** | [2.6 Ray Train Guide](2.6_ray_train_guide.md) |
...
> **Navigation**
> [← 2.4 Data Mix](2.4_pretraining_data_mix_curriculum.md) | **[Index](../README.md#15-repository-structure)** | [2.6 Ray Train →](2.6_ray_train_guide.md)
